...
//	Aggregate(crud.As(crud.Sum(field1), "sum_field1"), (crud.As(crud.Sum(field2), "sum_field2")).
//	Scan(ctx, &v)
//
...
func (e *NotSingularError) Error() string {
	return "crud: " + e.label + " not singular"
}
...
func (e *NotLoadedError) Error() string {
	return "crud: " + e.edge + " edge was not loaded"
}
...
func (e ConstraintError) Error() string {
	return "crud: constraint failed: " + e.msg
}
